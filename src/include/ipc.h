...
// Message types
#define MSG_ERROR              0x01 // either direction
#define MSG_CALL               0x02 // (Java) Launcher: call JNI symbol
#define MSG_RETURN             0x03 // (Launcher) Java: return value
#define MSG_JNIENV             0x04 // (Launcher) Java: JNIEnv call needed
#define MSG_JNIENV_RETURN      0x05 // (Java) Launcher: JNIEnv result
#define MSG_JNIENV_RETURN_DATA 0x06 // (Java) Launcher: Variable length JNIEnv return
#define MSG_LIST_SYMBOLS       0x07 // list all Java_* calls
